<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Plantilla.Master" AutoEventWireup="true" CodeBehind="TopDiez.aspx.cs" Inherits="WAVistas.Vistas.VistaReportes" %>
    ...
    <div style="margin-top: 70px; margin-left: 200px; padding: 20px;">
        <div class="row">
            ...
            <div class="col-md-3">Año
                <asp:TextBox ID="txtAnio" type="number" runat="server"></asp:TextBox>
            </div>
            <div class="col-md-2">
        ...
        <div class="row">
            <div class="col-md-12" style="width: 100%">
                ...
                <rsweb:ReportViewer ID="rvPrimero" runat="server" Font-Names="Verdana" Font-Size="12pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%" Height="100%" AsyncRendering="False" SizeToReportContent="True">
                    <LocalReport ReportPath="Reportes/Productos.rdlc">
                    </LocalReport>
                </rsweb:ReportViewer>
            </div>
        </div>
