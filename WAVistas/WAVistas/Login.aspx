        ...
        <div class="page">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 text-center signin">
                    ...
                    <!-- Email -->
                    <input type="email" class="form-control mb-4" placeholder="&#xf0e0; Correo electrónico" style="font-family: Arial, FontAwesome" />
                    <!-- Password -->
                    <input type="password" class="form-control mb-4" placeholder="&#xf023; Password" style="font-family: Arial, FontAwesome" />
                    <!-- Sign in button -->
                    <button class="btn btn-info btn-block LoginBtn" type="submit">INGRESAR</button>
                </div>
                <!--Column for signin-->
